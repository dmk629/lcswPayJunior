...
class QRPayController
{
    ...
    public function payForQRPay(Request $request)
    {
        ...
        var_dump($requestUrl);*/
        return context()->getResponse()->withCookie("trace_id",["value"=>$redirectResult["trace_id"],"path"=>"/","domain"=>"saobei.dnfmiracle.xyz"])->withData(["status"=>true,"errcode"=>0,"data"=>$redirectResult["redirect_url"]]);
    }
