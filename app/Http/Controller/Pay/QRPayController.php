...
class QRPayController
{
    ...
    public function payForQRPay(Request $request)
    {
        ...
        return context()->getResponse()->withCookie("trace_id",["value"=>$redirectResult["trace_id"],"path"=>"/","domain"=>""])->withData(["status"=>true,"errcode"=>0,"data"=>$redirectResult["redirect_url"]]);
    }
